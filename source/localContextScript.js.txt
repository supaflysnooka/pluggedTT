...
const startStickerShow = async () => {
    ...
    const placed = await fetch("https://deep-cut.fm/api/sticker.place", {
        "headers": {
        ...
        "referrer": "https://deep-cut.fm/profile/stickers",
...
const init = async () => {
    ...
    if (document.location.hostname.match(/deep-cut.fm/)) {
